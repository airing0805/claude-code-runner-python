...
| 文件 | 功能 |
|------|------|
| [manager.py](CoPaw 参考项目/src/copaw/app/crons/manager.py) | 定时任务管理器 - 调度器核心 |
| [models.py](CoPaw 参考项目/src/copaw/app/crons/models.py) | 数据模型 - 任务规范定义 |
| [executor.py](CoPaw 参考项目/src/copaw/app/crons/executor.py) | 任务执行器 - 执行逻辑 |
| [api.py](CoPaw 参考项目/src/copaw/app/crons/api.py) | REST API 端点 |
| [cron/repo/json_repo.py](CoPaw 参考项目/src/copaw/app/crons/repo/json_repo.py) | JSON 持久化存储 |
