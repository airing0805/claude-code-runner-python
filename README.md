...
- **Gitee**: `https://gitee.com/andy0805/claude-runner.git`
...
在 **OpenClaw** 和 **Skill** 生态火爆的今天，Claude Code Runner 为你提供最前沿的AI Agent开发体验！

本项目基于**规范驱动开发**，完全由AI开发。驱动目录为` docs\plan\功能规划 ` , 

任务调度的 agent 可以查看` data  ` 目录 
...
**OpenClaw兼容性**：Skill系统完全兼容OpenClaw标准，让你可以无缝迁移和复用现有的OpenClaw Skills！

**丰富的Skill库**：内置多种预设Skills，覆盖编程、文档、数据分析、内容创作等场景，开箱即用！

**自定义Skill开发**：轻松创建和部署自己的Skills，构建专属的AI能力矩阵！

Claude Code 本身就是一个强大的通用 AI 助手，配合 **OpenClaw生态的Skill系统** 可以完成各种任务：
